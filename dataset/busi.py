...
class myDataset(data.Dataset):
    def __init__(self, fold, split, aug=False):
        ...
        #     '/data2/cf_data/skinlesion_segment/BUSI_rawdata/BUSI/Train/Point_All/{}.npy'
...
def random_seperate_dataset():
    #    indexes = [l[:-4] for l in os.listdir('/raid/wl/BUSI/Train/Image/')]
    ...
    #    with open('/raid/wl/BUSI/data_split.json','w') as f:
    #        json.dump(names, f)
    return
